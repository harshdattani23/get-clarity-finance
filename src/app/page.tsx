            ...
            <div className="lg:col-span-7 flex flex-col items-start">
              ...
              <div className="grid grid-cols-2 gap-3 mb-8 w-full">
                <div className="flex items-center">
                  ...
                  <span className="text-sm">{t('hero.benefit1') as string}</span>
                </div>
                <div className="flex items-center">
                  <BookOpen className="w-5 h-5 text-lime-400 mr-2 flex-shrink-0" />
                  <span className="text-sm">{t('hero.benefit2') as string}</span>
                </div>
                <div className="flex items-center">
                  <TrendingUp className="w-5 h-5 text-lime-400 mr-2 flex-shrink-0" />
                  <span className="text-sm">{t('hero.benefit3') as string}</span>
                </div>
                <div className="flex items-center">
                  <Shield className="w-5 h-5 text-lime-400 mr-2 flex-shrink-0" />
                  <span className="text-sm">{t('hero.benefit4') as string}</span>
                </div>
              </div>
