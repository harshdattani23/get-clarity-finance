        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-green-50 border-l-4 border-green-500 p-6 rounded-r-lg">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h2 className="text-2xl font-bold text-green-800">{t('bull.title')}</h2>
            </div>
            <p className="font-semibold text-green-700 mb-2">{t('bull.subtitle')}</p>
          ...
          <div className="bg-red-50 border-l-4 border-red-500 p-6 rounded-r-lg">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h2 className="text-2xl font-bold text-red-800">{t('bear.title')}</h2>
            </div>
            <p className="font-semibold text-red-700 mb-2">{t('bear.subtitle')}</p>
            <ul className="list-disc list-inside space-y-1 text-gray-700">
              <li>{t('bear.char1')}</li>
              <li>{t('bear.char2')}</li>
              <li>{t('bear.char3')}</li>
