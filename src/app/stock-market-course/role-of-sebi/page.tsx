  ...
  return (
    ...
    >
      <div className="space-y-8">
        ...
        <div>
          <h2 className="text-2xl font-bold text-gray-800 mb-4">{t('mandate.title')}</h2>
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-lg border text-center">
              <Shield className="mx-auto w-12 h-12 text-blue-500 mb-3" />
              <h3 className="font-bold text-lg">{t('mandate.item1.title')}</h3>
              <p className="text-sm text-gray-600">{t('mandate.item1.p')}</p>
            </div>
            <div className="bg-white p-6 rounded-lg border text-center">
              <BookUser className="mx-auto w-12 h-12 text-green-500 mb-3" />
              <h3 className="font-bold text-lg">{t('mandate.item2.title')}</h3>
              <p className="text-sm text-gray-600">{t('mandate.item2.p')}</p>
            </div>
            <div className="bg-white p-6 rounded-lg border text-center">
              <AlertTriangle className="mx-auto w-12 h-12 text-red-500 mb-3" />
              <h3 className="font-bold text-lg">{t('mandate.item3.title')}</h3>
              <p className="text-sm text-gray-600">{t('mandate.item3.p')}</p>
            </div>
          </div>
        </div>
