        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-white p-6 rounded-lg border">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h2 className="text-2xl font-bold text-blue-800">{t('sensex.title')}</h2>
            </div>
            <p className="text-gray-600 mb-2" dangerouslySetInnerHTML={{ __html: t('sensex.p1') }} />
            <p className="text-sm text-gray-500">{t('sensex.p2')}</p>
          </div>
          <div className="bg-white p-6 rounded-lg border">
            <div className="flex items-center gap-3 mb-3">
              <LineChart className="w-8 h-8 text-green-500" />
              <h2 className="text-2xl font-bold text-green-800">{t('nifty.title')}</h2>
            </div>
            <p className="text-gray-600 mb-2" dangerouslySetInnerHTML={{ __html: t('nifty.p1') }} />
            <p className="text-sm text-gray-500">{t('nifty.p2')}</p>
          </div>
        </div>
