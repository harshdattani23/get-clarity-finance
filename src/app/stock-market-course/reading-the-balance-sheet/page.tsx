      ...
      <AnimatedDiv delay={0.2}>
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-6">
          <div className="bg-blue-50 p-6 rounded-lg border border-blue-200">
            <h3 className="font-bold text-lg text-blue-800 flex items-center mb-2"><Landmark className="w-5 h-5 mr-2" />{t('assets')}</h3>
            <p className="text-gray-700" dangerouslySetInnerHTML={{ __html: t('assetsP') }} />
          </div>
          <div className="bg-red-50 p-6 rounded-lg border border-red-200">
            <h3 className="font-bold text-lg text-red-800 flex items-center mb-2"><HandCoins className="w-5 h-5 mr-2" />{t('liabilities')}</h3>
            <p className="text-gray-700" dangerouslySetInnerHTML={{ __html: t('liabilitiesP') }} />
          </div>
          <div className="bg-green-50 p-6 rounded-lg border border-green-200">
            <h3 className="font-bold text-lg text-green-800 flex items-center mb-2"><ShieldCheck className="w-5 h-5 mr-2" />{t('equity')}</h3>
