    ...
    >
      <div className="p-8 bg-white dark:bg-gray-900 rounded-lg shadow-lg">
        ...
        <section className="mb-12 bg-yellow-50 dark:bg-yellow-900/20 p-6 rounded-xl shadow-md">
            <h3 className="text-2xl font-bold mb-4 text-yellow-700 dark:text-yellow-300">{t('diversificationExample.title')}</h3>
            <p className="text-lg text-gray-800 dark:text-gray-300 mb-4">{t('diversificationExample.intro')}</p>
            <div className="grid md:grid-cols-2 gap-8">
                <div>
                    <h4 className="font-semibold text-xl mb-2">{t('diversificationExample.undiversified')}</h4>
                </div>
                <div>
                    <h4 className="font-semibold text-xl mb-2">{t('diversificationExample.diversified')}</h4>
                    <ul className="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-300">
                        <li>{t('diversificationExample.item1')}</li>
                        <li>{t('diversificationExample.item2')}</li>
                        <li>{t('diversificationExample.item3')}</li>
                        <li>{t('diversificationExample.item4')}</li>
                    </ul>
                </div>
            </div>
        ...
        <section className="mt-12 p-6 bg-gray-800 text-white rounded-lg">
          <h3 className="text-2xl font-bold mb-4">{t('bottomLine.title')}</h3>
