...
export default function IntroFundamentalAnalysisPage() {
  ...
  return (
    ...
    >
      <AnimatedDiv>
        <h2 className="text-3xl font-bold text-gray-800 mb-4">{t('whatIsIt')}</h2>
      ...
      <AnimatedDiv delay={0.2}>
        <h2 className="text-3xl font-bold text-gray-800 mb-4 mt-8">{t('coreComponents')}</h2>
        <div className="grid md:grid-cols-2 gap-6 mt-6">
          <div className="bg-yellow-50 p-6 rounded-lg border border-yellow-200">
            <h3 className="font-bold text-lg text-yellow-800 flex items-center mb-2"><BookOpen className="w-5 h-5 mr-2" />{t('qualitativeAnalysis')}</h3>
            <p className="text-gray-700" dangerouslySetInnerHTML={{ __html: t('qualitativeAnalysisP') }} />
          </div>
          <div className="bg-green-50 p-6 rounded-lg border border-green-200">
            <h3 className="font-bold text-lg text-green-800 flex items-center mb-2"><BarChart className="w-5 h-5 mr-2" />{t('quantitativeAnalysis')}</h3>
      ...
      <AnimatedDiv delay={0.4}>
        <h2 className="text-3xl font-bold text-gray-800 mb-4 mt-8">{t('keyDocuments')}</h2>
        <ul className="space-y-4 mt-6">
            <li className="flex items-start">
                <FileText className="w-6 h-6 text-blue-500 mr-3 flex-shrink-0 mt-1" />
                <div>
                    <h3 className="font-bold text-lg text-gray-800">{t('balanceSheet')}</h3>
            ...
            <li className="flex items-start">
                ...
                <div>
                    <h3 className="font-bold text-lg text-gray-800">{t('incomeStatement')}</h3>
