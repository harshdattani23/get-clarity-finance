...
import ComprehensiveFraudSchemesAudioPlayer from '@/components/ComprehensiveFraudSchemesAudioPlayer';
...
export default function ComprehensiveFraudSchemesPage() {
  ...
  const scenarios = [
    {
      id: 1,
      text: "An investment firm operates with a licensed subsidiary in Luxembourg, maintains offices in 12 countries, employs former regulatory officials, and offers diversified hedge fund strategies. However, their primary fund consistently shows 2.8% monthly returns regardless of market conditions, client statements show positions in illiquid private equity that cannot be independently verified, and new investor capital requirements have increased 300% in the past 6 months.",
      options: [
        "This appears legitimate due to regulatory compliance and professional team",
        "The consistent returns and unverifiable positions suggest a sophisticated hybrid fraud using regulatory arbitrage",
        "This is likely a legitimate but highly exclusive investment opportunity"
      ],
      answer: "The consistent returns and unverifiable positions suggest a sophisticated hybrid fraud using regulatory arbitrage",
    },
    {
      id: 2,
      text: "A fintech platform uses AI-driven social media sentiment analysis to execute trades, has partnerships with major exchanges, published peer-reviewed research on algorithmic trading, and maintains transparent fee structures. Yet their algorithm shows unusual trading patterns during low-volume periods, social media mentions of their platform spike 400% before major announcements, and blockchain analysis reveals coordinated wallet activities from their institutional trading desk.",
      options: [
        "This represents legitimate innovation in algorithmic trading with proper research backing",
        "The unusual trading patterns and coordinated activities indicate market manipulation disguised as legitimate fintech operations",
        "This is normal competitive behavior in algorithmic trading markets"
      ],
      answer: "The unusual trading patterns and coordinated activities indicate market manipulation disguised as legitimate fintech operations",
    },
    {
      id: 3,
      text: "A private wealth management group has operated for 15 years, manages $2B in assets, employs 200+ staff across multiple offices, undergoes annual third-party audits, and maintains insurance coverage. However, recent SEC filings show discrepancies in asset valuations, their custodian relationships have changed three times in two years, and sophisticated clients report inability to withdraw more than $50M annually despite contractual terms allowing larger redemptions.",
      options: [
        "This appears to be normal operational challenges for a large wealth management firm",
        "The valuation discrepancies and withdrawal restrictions suggest liquidity issues masking potential fraud despite legitimate appearance",
        "This reflects prudent risk management in volatile market conditions"
      ],
      answer: "The valuation discrepancies and withdrawal restrictions suggest liquidity issues masking potential fraud despite legitimate appearance",
    },
  ];
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <h1 className="text-lg font-semibold">Comprehensive Fraud Schemes</h1>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex justify-between items-center mb-8">
            ...
            {overviewStep === 1 && (
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
                <h2 className="text-2xl font-bold mb-4">Step 1: Understanding Advanced Fraud Networks</h2>
                ...
                <div className="bg-white rounded-lg p-6 mb-6">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-lg font-semibold">Advanced Fraud Detection Video</h3>
                  ...
                  <p className="text-sm text-gray-600 mb-4">Learn about sophisticated fraud schemes • 12 minutes</p>
                ...
                <div className="bg-white rounded-lg p-6 mb-6">
                  ...
                  <div className="relative mb-4">
                    <ClientOnly>
                      <ComprehensiveFraudSchemesAudioPlayer 
                        defaultLanguage={clerkUser?.publicMetadata?.language as any || 'en'}
                        className="mb-4"
                ...
                <div className="bg-gray-50 rounded-lg p-6 mb-6">
                  <h3 className="text-lg font-semibold mb-4">Advanced Multi-Layered Fraud Networks</h3>
                  <p className="text-gray-700 mb-4">Modern sophisticated fraud operations function as complex criminal enterprises with multiple interconnected layers. These networks employ advanced financial engineering, regulatory arbitrage, and cross-jurisdictional structures to evade detection and maximize victim exploitation.</p>
                  <p className="text-gray-700 mb-4">Unlike simple Ponzi schemes, these operations integrate legitimate business activities with fraudulent components, creating a hybrid model that can operate undetected for years while generating massive illicit profits.</p>
                  
                  <div className="mt-4">
                    <h4 className="font-medium mb-3">Advanced Network Characteristics:</h4>
                    <ul className="space-y-2 text-gray-700">
                      <li className="flex items-start gap-2">
                        <div className="w-1.5 h-1.5 rounded-full bg-blue-500 mt-2 flex-shrink-0" />
                        <span><strong>Layered Corporate Structures:</strong> Multiple shell companies across different jurisdictions to obscure beneficial ownership and fund flows</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="w-1.5 h-1.5 rounded-full bg-blue-500 mt-2 flex-shrink-0" />
                        <span><strong>Technology Integration:</strong> AI-driven social media manipulation, algorithmic trading facades, and blockchain obfuscation techniques</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="w-1.5 h-1.5 rounded-full bg-blue-500 mt-2 flex-shrink-0" />
                        <span><strong>Regulatory Arbitrage:</strong> Exploiting differences in international regulations and enforcement gaps between jurisdictions</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="w-1.5 h-1.5 rounded-full bg-blue-500 mt-2 flex-shrink-0" />
                        <span><strong>Professional Enablers:</strong> Corrupt lawyers, accountants, and financial advisors who provide legitimacy and regulatory cover</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="w-1.5 h-1.5 rounded-full bg-blue-500 mt-2 flex-shrink-0" />
                        <span><strong>Market Manipulation Integration:</strong> Coordinated pump-and-dump schemes combined with insider trading and spoofing operations</span>
                      </li>
                    </ul>
                  </div>
                </div>
            ...
            {overviewStep === 2 && (
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
                <h2 className="text-2xl font-bold mb-6">Step 2: Advanced Fraud Techniques</h2>
                
                {/* Basic Fraud Type Cards - Educational First */}
                <div className="mb-8">
                  <h3 className="text-xl font-semibold mb-6 text-gray-800">Modern Fraud Techniques</h3>
                  <div className="grid md:grid-cols-3 gap-4">
                    {['tech_ponzi', 'hybrid_schemes', 'legitimate_fronts'].map((fraudType, index) => (
                      <motion.div 
                        key={fraudType}
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                      ...
                      >
                        ...
                        <div className="relative z-10">
                          <div className="flex items-center justify-between mb-3">
                            <div className="flex items-center gap-2">
                              <div className={`w-3 h-3 rounded-full ${
                                fraudType === 'tech_ponzi' ? 'bg-red-400' :
                                fraudType === 'hybrid_schemes' ? 'bg-orange-400' : 'bg-purple-400'
                              }`} />
                              <h3 className="font-bold text-gray-800">{
                                fraudType === 'tech_ponzi' ? 'Tech-Enabled Ponzi' :
                                fraudType === 'hybrid_schemes' ? 'Hybrid Schemes' : 'Legitimate Fronts'
                              }</h3>
                            </div>
                            {completedActivities.has(`fraud-type-${fraudType}`) && (
                              <motion.div
                          ...
                          <p className="text-sm text-gray-700 mb-4">{
                            fraudType === 'tech_ponzi' ? 'Sophisticated schemes leveraging AI algorithms for social media manipulation, fake blockchain projects with smart contract vulnerabilities, and algorithmic trading platforms that execute coordinated market manipulation while appearing as legitimate fintech operations.' :
                            fraudType === 'hybrid_schemes' ? 'Complex operations combining legitimate hedge fund activities with fraudulent investment pools, using real trading profits to pay early investors while simultaneously operating parallel Ponzi structures for retail clients through different legal entities.' : 
                            'Elaborate networks of legitimate businesses (consulting firms, investment banks, audit companies) that provide credible cover for fraudulent activities, employing professional staff and maintaining real operations to pass regulatory scrutiny while facilitating large-scale investment fraud.'
                          }</p>
                ...
                <div className="space-y-6">
                  <div className="text-center">
                    <h3 className="text-xl font-semibold text-gray-800 mb-2">Advanced Fraud Analysis Exercises</h3>
                    <p className="text-gray-600">Master sophisticated fraud detection through complex scenario analysis</p>
                  </div>

                  {/* Advanced Fraud Network Analysis */}
                  <div className="bg-white rounded-lg p-6 border border-gray-200">
                    <h3 className="text-xl font-semibold mb-4">Multi-Jurisdictional Fraud Network Analysis</h3>
                    <p className="text-gray-600 mb-6">Analyze complex fraud networks that span multiple countries, regulatory systems, and corporate structures</p>
                    
                    <FraudMatchingGame 
                      onComplete={(score) => {
                        addXP(35, 'advanced-network-analysis-completed');
                      ...
                      isCompleted={completedActivities.has('advanced-network-analysis-completed')}
                    />
                  </div>

                  {/* Complex Fraud Timeline Builder */}
                  <div className="bg-white rounded-lg p-6 border border-gray-200">
                    <h3 className="text-xl font-semibold mb-4">Sophisticated Fraud Operation Timeline</h3>
                    <p className="text-gray-600 mb-4">Reconstruct the evolution of a complex multi-layered fraud scheme involving regulatory arbitrage and technology manipulation</p>
                    
                    <TimelineBuilder 
                      events={[
                        { id: '1', text: 'Establish legitimate holding company in Switzerland', stage: 'early' },
                        { id: '2', text: 'Launch AI-powered trading platform with real algorithm', stage: 'early' },
                        { id: '3', text: 'Register subsidiary investment vehicles in Cayman Islands', stage: 'early' },
                        { id: '4', text: 'Begin parallel Ponzi operations through separate entities', stage: 'middle' },
                        { id: '5', text: 'Deploy algorithmic social media manipulation campaign', stage: 'middle' },
                        { id: '6', text: 'Coordinate pump-and-dump schemes with legitimate trading', stage: 'middle' },
                        { id: '7', text: 'Regulatory investigation triggers fund freezes', stage: 'end' },
                        { id: '8', text: 'Complex unwinding reveals billions in investor losses', stage: 'end' }
                      ]}
                      onComplete={() => addXP(30, 'complex-timeline-completed')}
                      isCompleted={completedActivities.has('complex-timeline-completed')}
                    />
                  </div>
                </div>
            ...
            {overviewStep === 3 && (
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
                ...
                <p className="text-gray-700 mb-6">Master the identification of sophisticated fraud indicators in complex, seemingly legitimate operations that employ professional facades and regulatory compliance as cover.</p>
                
                {/* Advanced Red Flag Analysis */}
                <div className="bg-white rounded-lg p-6 mb-6">
                  <h3 className="text-xl font-semibold mb-4 text-gray-800">🚩 Sophisticated Fraud Pattern Recognition</h3>
                  <p className="text-gray-600 mb-6">Analyze complex scenarios involving seemingly legitimate operations that may harbor sophisticated fraud schemes. These scenarios require advanced analytical skills to identify subtle indicators that suggest fraudulent activity beneath professional facades. Each scenario awards 25 XP when completed correctly.</p>
            ...
            {/* Step 4: Advanced Fraud Investigation Simulator */}
            {overviewStep === 4 && (
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
                <h2 className="text-2xl font-bold mb-4">Advanced Fraud Investigation Simulator</h2>
                <p className="text-gray-700 mb-6">Conduct comprehensive analysis of complex fraud networks using advanced investigative techniques. Apply sophisticated pattern recognition and cross-jurisdictional analysis skills in realistic high-stakes scenarios!</p>
                
                <div className="bg-white rounded-lg p-6 mb-6">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-xl font-semibold">Multi-Jurisdictional Fraud Investigation</h3>
                    <div className="flex items-center gap-2 text-sm bg-yellow-50 px-3 py-1 rounded-full border border-yellow-200">
                      <Trophy className="w-4 h-4 text-yellow-600" />
                  ...
                  <FraudSimulator 
                    onComplete={() => {
                      addXP(50, 'advanced-simulator-completed');
                      handleCompleteLesson();
                    }}
                    isCompleted={completedActivities.has('advanced-simulator-completed')}
                  />
                  
                  {completedActivities.has('advanced-simulator-completed') && (
                    <div className="bg-green-50 rounded-lg p-4 mt-4 border border-green-200">
                      <div className="flex items-center gap-2 text-green-600 text-sm mb-2">
                        <CheckCircle className="w-4 h-4" />
                        <span>Advanced Investigation Completed (+50 XP) - Course Complete! 🎉</span>
                      </div>
                      <p className="text-sm text-gray-600 mb-3">Congratulations! You've successfully mastered the Comprehensive Fraud Schemes course and can now identify sophisticated multi-layered fraud operations.</p>
                      <button
                        onClick={() => {
